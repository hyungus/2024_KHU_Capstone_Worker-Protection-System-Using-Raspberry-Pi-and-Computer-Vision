...
def generate_frames():
    global doze, fall
    doze = fall = last_warning_time = last_play_time = 0
...
# Detect fall
        ...
        if ((len(fullbody_rot_90) >= 1) or (len(fullbody_rot_270) >= 1) or (mqtt_client.fall_90_count!=0) or (mqtt_client.fall_270_count!=0)):  
